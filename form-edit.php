...
<html>
<head>
    <title>Formulir Edit joki | SMK Coding</title>
...
$sql = "SELECT * FROM history_db WHERE id=$id";
...
?>
        ...
        <p>
            ...
            <input class="one" type="text" name="nama" <?php echo $joki['nama'] ?> />
        </p>
        <p>
            <label for="cch">CCH </label>
            <input class="two" type="text" name="cch"<?php echo $joki['cch'] ?> />
        </p>
        <p>
            <label for="boosting">Boosting: </label>
            <input type="text" name="boosting"<?php echo $joki['boosting'] ?> />
        </p>
        <p>
            <label for="harga">Harga: </label>
            <input class="three" type="text" name="harga"<?php echo $joki['harga'] ?> />
        </p>
        <p>
            <label for="tanggal">Tanggal: </label>
            <input class="four" type="date" name="tanggal"<?php echo $joki['tanggal'] ?> />
        </p>
        <p>
